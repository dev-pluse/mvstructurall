        ...
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/75">
          <div className="w-3/4 text-center md:w-2/4 pt-20">
            <Typography
              variant="h1"
              color="white"
              className="mb-4 md:text-4xl lg:text-5xl capitalize "
            >
              Welcome To  <span className="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text md:text-4xl lg:text-6xl font-extrabold text-transparent">MVStructurALL</span>
            </Typography>
            <Typography
              variant="lead"
              color="white"
