  ...
  return (
    <div className="capitalize text-blue-700 bg-black overflow-x-hidden">
      ...
      <div className="block md:flex lg:text-left md:justify-between  md:items-center md:text-center w-full h-screen p-10">
        ...
        <div className=" ">
          <img className="rounded-xl m-4 -ml-6 mt-5" src={Logo} width={700} alt="" />
        </div>
        ...
        <button className="md:hidden text-center ml-28 mt-6 bg-blue-500 text-black rounded-md p-2 hover:scale-125 duration-500" onClick={()=>navigate('/contact')}>get started</button>
...
<p className="p-3 text-md mt-8 capitalize md:text-4xl "> let's build your career towards Safety,Stability,Sustainability </p>
</div>
...
<div>
      ...
      <div className=" items-center twzt-center text-white md:grid md:grid-flow-col w-full h-auto md:h-screen bg-blue-gray-600">
        ...
        <div className="bg-black md:p-10 md:h-screen border-r-4">
          <h1 className="text-center text-blue-700 text-3xl p-4"> what you learn</h1>
        ...
        <div className="bg-black p-10 md:h-screen">
          <h1 className="text-center text-blue-700 text-3xl md:p-4"> what you learn</h1>
          ...
          <ul className="pl-20 md:pl-52 p-3 list-decimal md:text-xl">
            ...
            <li    className="py-1 self-center"     >  DRAWING & DESIGNING LIFE TIME EXPERT SUPPORT        </li>
            <li    className="py-1 self-center"     >    DISCOUNTS ON MASTER PROGRAMMES          </li>
