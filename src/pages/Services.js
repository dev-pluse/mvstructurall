  ...
  return (
    <div className="bg-black text-white overflow-x-hidden">
        ...
        <meta
          ...
          solutions in civil and structural engineering.Our Services.Engineering Design.Projects.Internship and Professional Training-Our expert team specializes in creating robust and cost-effective engineering designs tailored to your specific needs. Whether it's residential, commercial, or industrial projects, we are dedicated to providing creative and efficient solutions"
        />
      ...
      <div className="justify-center text-center">
        <h1 className="text-sm md:text-4xl font-bold items-center pl-50  border-b-4 p-10"> Our Services</h1>
                                                      ...
                                                      <div className=' border-2 border-blue-700 block md:flex lg:text-left md:justify-between  md:items-center md:text-center w-full p-10 md:flex-row-reverse md:border-none'>                                                 
                                                    ...
                                                    <div className='border-2 border-blue-700 block md:flex lg:text-left md:justify-between  md:items-center md:text-center w-full  p-10 md:shadow-black shadow-sm'>                                                 
                                                        <div className='shadow-black shadow-md p-10 rounded-3xl'>
                                                    ...
                                                    <div className='block border-2 border-blue-700 md:flex lg:text-left md:justify-between  md:items-center md:text-center w-full p-10 md:flex-row-reverse md:shadow-black shadow-xs md:border-none'>                                                 
                                                        <div className='shadow-black shadow-md p-10 rounded-3xl'>
                                                    ...
                                                    <div className='block border-2 border-blue-700 md:flex lg:text-left md:justify-between  md:items-center md:text-center w-full p-10 md:shadow-black shadow-md'>                                                 
                                                        <div className='shadow-black shadow-md p-10 rounded-3xl'>
                                                    ...
                                                    <div className='block border-2 border-blue-700 md:flex lg:text-left md:justify-between  md:items-center md:text-center w-full p-10 md:flex-row-reverse md:shadow-black shadow-md md:border-none'>                                                 
